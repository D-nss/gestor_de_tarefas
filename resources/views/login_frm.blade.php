    ...
    <div class='login-box'>
        ...
        <form action="{{route('login_submit')}}" method="post">
            ...
            <div class="mb-3">
                ...
                @error('text_username')
                    <br>
                    <div class="alert alert-danger p-2">{{$errors->get('text_username')[0]}}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                @error('text_password')
                    <br>
                    <div class="alert alert-danger p-2">{{$errors->get('text_password')[0]}}</div>
                @enderror
            </div>
            <div class="mb-3">
            ...
            @if(session()->has('login_error'))
                <div class="alert alert-danger p-2">{{session()->get('login_error')}}</div>
            @endif
        </form>
    </div>
</div>
